...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Collapsible Responsive(mobile) Menu - Ace Admin</title>
							...
							<div class="col-xs-12">
								...
								<div class="well well-sm">
									<h4 class="lighter no-margin-bottom">
										...
										<a href="#basics/sidebar.mobile.style3" "="" class="pink btn-display-help"> Collapsible mobile menu help </a>
									</h4>
								</div>
